...
export default function RejectionCard({
  ...
  return (
    <div className="rounded-2xl border border-sky-200 bg-sky-50 p-6 text-center">
      ...
      <h2 className="mt-3 text-lg font-semibold text-sky-900">{HEADINGS[reason]}</h2>
      <p className="mt-1 text-sm text-sky-800">{message}</p>

      {retakeTips.length > 0 && (
        <div className="mx-auto mt-4 max-w-sm rounded-xl bg-white/70 p-4 text-left">
